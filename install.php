...
// Копируем классы для шифрования логина & пароля
copy("admin/app/classes/MLogin.php", "app/classes/MLogin.php");
copy("admin/app/classes/CLogin.php", "app/classes/CLogin.php");

/**
 * преобразуем логин и пароль
 * @var \app\classes\CLogin $prepared_authorization
 */
$prepared_authorization = Factory::getClassInst("CLogin");
...
$add_review = /** @lang MySQL */ "INSERT INTO
                reviews(page_id, name, language, review, autor, visible, state, created, rating, email)
                VALUES(:page_id, :name, :lng, :rev, :autor, :vis, :state, :created, :rating, :email)";

// users
$adduser = /** @lang MySQL */ "INSERT INTO users(login, password, full_name) VALUES(:login, :password, :name)";
...
if(
    ...
    && $mydbobj->sql(
        ...
        ['id' => '7', 'lng' => 'en', 'icon' => 'icon-comments', 'icon_size' => 'icon-large',
            'menu_number' => '0', 'name' => 'Reviews', 'pos' => '7', 'vis' => '1',
            'vis_in_main' => '1', 'vis_in_sidebar' => '0', 'content' => '',
    ...
    && $mydbobj->sql(
        ...
        ['id' => '8', 'lng' => 'en', 'icon' => 'icon-envelope', 'icon_size' => 'icon-large',
            'menu_number' => '0', 'name' => 'Contacts', 'pos' => '8', 'vis' => '1',
            'vis_in_main' => '1', 'vis_in_sidebar' => '0', 'content' => '',
    ...
    && $mydbobj->sql(
        $add_review,
        ['page_id' => '5', 'name' => 'Первый отзыв', 'lng' => 'ru',
    ...
    && $mydbobj->sql(
        $add_review,
        ['page_id' => '7', 'name' => 'First review', 'lng' => 'en',
    ...
    && $mydbobj->sql(
        $add_review,
        ['page_id' => '5', 'name' => 'Второй отзыв', 'lng' => 'ru',
            'rev' => 'Пример отзыва',
            'autor' => 'Администратор сайта', 'vis' => '1', 'state' => 'good',
            'created' => $dt, 'rating' => '4', 'email' => 'clubintellect@mail.ru']
    )
    && $mydbobj->sql($adduser, ['login' => $admin_login, 'password' => $admin_password, "name" => "Администратор"])
)
{
    echo "<div class='col-md-2'>OK</div></div>";
}
...
unlink('app/classes/CLogin.php');
unlink('app/classes/MLogin.php');
